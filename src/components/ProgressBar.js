    ...
    return (
        <View style={styles.container}>
            <View style={styles.icon}>
                ...
                <Text style={{ color: mode === 0 ? currentTheme.defaultTextColor : COLORS.cyan }}>Shipping</Text>
            </View>
            ...
            <View style={styles.icon}>
                ...
                <Text style={{ color: mode === 0 ? null : mode === 1 ? currentTheme.defaultTextColor : COLORS.cyan }}>Payment</Text>
            </View>
            <View style={styles.line} />
            <View style={styles.icon}>
                <Icon type={IconType.Ionicons} name={'bag-check-outline'} color={mode === 0 || mode === 1 ? null : COLORS.black} />
                <Text style={{ color: mode === 0 || mode === 1 ? null : currentTheme.defaultTextColor }}>Review</Text>
            </View>
        </View>
    )
}
